	...
	function outputResponse(loader){
		...
		function sendRequestGet(){
			if(!document.getElementById('sync').checked){
				dhtmlxAjax.get("php/processRoulette.php?"+encodeURI(document.getElementById('params').value),outputResponse);
				alert("Request Sent");
			}else{
				var loader = dhtmlxAjax.getSync("php/processRoulette.php?"+encodeURI(document.getElementById('params').value));
				alert("Request Sent");
